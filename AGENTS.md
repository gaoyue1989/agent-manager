...
| agent-framework-ci | `mvn test`（83 类 / 848 个 @Test，实跑 825 用例） | 核心/多副本/沙箱三 job（见 `agent-framework/docs/e2e-ci-plan.md`） | `gaoyue1989/agent-framework:agentscope-{maven 版本}-v{YYYYMMDD}`（如 agentscope-2.1.0-v20260907） |
