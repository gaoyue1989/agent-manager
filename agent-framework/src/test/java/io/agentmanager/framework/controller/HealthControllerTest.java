...
class HealthControllerTest {
    ...
    void healthShouldReturnOk() throws Exception {
        var llm = new AgentManagerProperties.LLMConfig("sk-test", "gpt-4", "https://api.openai.com/v1", "openai", 0.7, 4096, 120, true, 0, "", null);
    ...
    void healthShouldShowLlmNotConfigured() throws Exception {
        var llm = new AgentManagerProperties.LLMConfig("", "", "", "openai", 0.7, 4096, 120, true, 0, "", null);
        when(props.llm()).thenReturn(llm);
